...
import cn.edu.zjou.jin.po.TypeInfo;
...
public class BookInfoController {
    ...
    public DataInfo bookAll(BookInfo bookInfo, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "15") Integer limit){
